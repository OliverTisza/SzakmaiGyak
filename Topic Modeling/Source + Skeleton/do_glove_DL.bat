...
python sparse_matrix_normalizer.py --path Glove_DL
...
python matrix_creator.py --path Glove_DL --NT 100 2>> info.txt
python matrix_plotter.py --path Glove_DL --NT 100 2>> info.txt
python matrix_mult.py --path Glove_DL --NT 100 2>> info.txt
python matrix_evaluator.py --path Glove_DL --NT 100 2>> info.txt
